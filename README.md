...
![gradle-plugin](https://img.shields.io/maven-central/v/com.clauto.tools.refine/gradle-plugin?label=gradle-plugin)
![annotation-processor](https://img.shields.io/maven-central/v/com.clauto.tools.refine/annotation?label=annotation-processor)
![annotation](https://img.shields.io/maven-central/v/com.clauto.tools.refine/annotation?label=annotation)
![runtime](https://img.shields.io/maven-central/v/com.clauto.tools.refine/runtime?label=runtime)
...
2. Add annotation dependency
   ...
   ```gradle
   dependencies {
       annotationProcessor 'com.clauto.tools.refine:annotation-processor:<version>'
       compileOnly 'com.clauto.tools.refine:annotation:<version>'
   }
   ```
...
1. Apply this plugin in the final Android application module
   ...
   ```groovy
   plugins {
       id('com.clauto.tools.refine') version '<version>'
   }
   ```
   ...
   subprojects {
       plugins.withId("com.android.base") {
           plugins.apply('com.clauto.tools.refine')
       }
   }
   ```
...
3. Import the "Refine" class (Optional, if you don't need the "unsafeCast" method)
   ...
   ```gradle
   dependencies {
       implementation("com.clauto.tools.refine:runtime:<version>")
   }
   ```
